  ...
  return (
    <header
      className={`top-0 z-40 mx-auto w-full flex-none transition-all duration-100 ease-in md:backdrop-blur-sm
        ${isSticky ? 'sticky bg-white/80 shadow-md' : 'relative bg-transparent'}
      ...
      <div className="mx-auto w-full max-w-7xl md:flex md:justify-between md:py-3.5 md:px-4">
        <div
          className={`flex justify-between py-3 px-3 md:py-0 md:px-0 ${
            isToggleMenuOpen ? 'md:bg-transparent md:border-none bg-white border-b border-gray-200' : ''
          }`}
        >
          <Link
        ...
        <nav
          ...
          } w-auto overflow-y-auto md:mx-5 md:flex md:h-auto md:items-center md:overflow-visible text-gray-900`}
